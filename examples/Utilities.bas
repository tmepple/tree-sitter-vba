...
' FindSheet - Safe worksheet lookup by name
...
' FindRowsByPrefix - Find all rows where a cell value starts with a given prefix
' Returns a Collection of row numbers
...
' FindTotalRow - Find the row containing "Total" in a given column
...
' FormatCurrency - Format a number as currency string for display
